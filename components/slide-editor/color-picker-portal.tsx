...
export default function ColorPickerPortal({
  ...
  // Prevent mouse down from bubbling to avoid losing focus
  ...
  const colorPickerContent = (
    <div
      ...
      onMouseDown={handleMouseDown} // Prevent losing focus when clicking inside
    >
      {/* Header with tabs */}
  ...
  return typeof document !== "undefined" ? createPortal(colorPickerContent, document.body) : null
}
