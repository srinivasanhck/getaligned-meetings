...
// // Add this function after the jsonToHTML function
...
//               ref={leftEditableRef}
//               contentEditable
//               className="prose prose-sm max-w-none min-h-[500px] focus:outline-none border border-gray-200 rounded-md p-4"
//               dangerouslySetInnerHTML={{ __html: leftSideHTML }}
//             />
//           )}
//         </div>
...
//                   contentEditable
//                   className="prose prose-sm max-w-none min-h-[500px] focus:outline-none border border-gray-200 rounded-md p-4 deal-summary-content"
//                   dangerouslySetInnerHTML={{ __html: rightSideHTMLMap[activeRightTab] || "" }}
//                 />
//               )}
      ...
      <div className="flex-1 flex justify-between overflow-hidden">
        ...
        <div className="w-[32%] h-full overflow-hidden pr-6 pt-4 pl-2 flex items-start">
          ...
          >
            ...
            {/* Right side content */}
            <div className="flex-1 overflow-y-auto custom-scrollbar p-4 pt-1">
              {/* View mode content */}
              {!isEditMode && activeRightTab && rightSideHTMLMap[activeRightTab] && (
                <div
                  ref={rightContentRef}
