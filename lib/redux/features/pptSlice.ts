...
export const pptSlice = createSlice({
  ...
  reducers: {
    ...
    setOutline: (state, action: PayloadAction<any[]>) => {
...
export const {
  setTitle, setOutline, setIsGeneratingOutline,setSlides,setLoadingSlides, setSlidesError,
  setSelectedTemplate, setError, updateSlide } = pptSlice.actions
